...
<template>
  <div class="app">
    ...
    <div class="page">
      <!--背景-->
      <div class="bg">
        <img :src="'http://9i.dvmama.com/free/huibenjie/huibenjie_pass/bg.jpg'" @load="bgPicOnLoad">
      </div>
      ...
      <div class="content">
        ...
        <div class="pass" v-for="(pass, i) in passList"
          ...
          <img v-show="!isOpenEye" class="head" :src="'http://9i.dvmama.com/free/huibenjie/huibenjie_pass/head.png'">
          <img v-show="isOpenEye" class="head" :src="'http://9i.dvmama.com/free/huibenjie/huibenjie_pass/head-1.png'">
        ...
        <div ref="clouds">
          <img class="cloud" v-for="(pass, i) in passList" v-if="i !== 0"
               :class="['cloud'+(i+1)]"
               :src="'http://9i.dvmama.com/free/huibenjie/huibenjie_pass/cloud-' + ((i+1) >= 10 ? (i+1) : ('0'+(i+1))) + '.png'">
        </div>

        <!--游戏规则按钮-->
        <img class="rule-btn" :src="'http://9i.dvmama.com/free/huibenjie/huibenjie_pass/rule-btn.png'" @click="showPopRule(true)">

        <!--音乐开关-->
        <img class="music-btn-open" :src="'http://9i.dvmama.com/free/huibenjie/huibenjie_pass/music-btn-open.png'" v-if="musicOpen" @click="closeMusic">
        <img class="music-btn-close" :src="'http://9i.dvmama.com/free/huibenjie/huibenjie_pass/music-btn-close.png'" v-if="!musicOpen" @click="openMusic">
        <audio ref="music" :src="'http://9i.dvmama.com/free/huibenjie/huibenjie_pass/music.mp3'" loop></audio>

        <!--游戏规则浮层-->
        <div class="pop-rule" :class="{show: isPopRuleShow}" @click="showPopRule(false)">
          <div class="rule-pic" @click="$event.stopPropagation()">
            <span>
              <img :src="'http://9i.dvmama.com/free/huibenjie/huibenjie_pass/pop-rule.png'">
        ...
        <!--各种弹窗-->
        <com-pic-display-box ref="pop-begin" id="pop-begin" :src="'http://9i.dvmama.com/free/huibenjie/huibenjie_pass/pop-begin.png'"></com-pic-display-box>
        <com-pic-display-box ref="pop-miss-pass" id="pop-miss-pass" :src="'http://9i.dvmama.com/free/huibenjie/huibenjie_pass/pop-miss-pass.png'"></com-pic-display-box>
        <com-pic-display-box ref="pop-miss-day" id="pop-miss-day" :src="'http://9i.dvmama.com/free/huibenjie/huibenjie_pass/pop-miss-day.png'"></com-pic-display-box>
        <com-pic-display-box ref="pop-all-over" id="pop-all-over" :src="'http://9i.dvmama.com/free/huibenjie/huibenjie_pass/pop-all-over.png'"></com-pic-display-box>
      </div>
    </div>
  </div>
</template>
  ...
  export default {
    ...
    mounted: function () {
      ...
      share.setShareInfo({
        ...
        imgUrl: 'http://9i.dvmama.com/free/huibenjie/huibenjie_pass/share-pic.jpeg', // 分享图标
      });
