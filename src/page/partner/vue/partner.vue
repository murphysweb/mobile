<template>
    <div class='container'>
        <div class='guide1'>
            <img src="//9i.dvmama.com/free/2017/06/27/partner_bg.png?x-oss-process=image/quality,Q_80/format,jpg" class='guide1Bg'>
            <div class='guide1Title guide1all'>支付成功</div>
            ...
            <div v-if="is_365kd == 0" class='guide1Btn guide1all' @click='goProfile'>提交</div>
            <div v-if="is_365kd == 1" class='guide1Btn guide1all' @click='goProfile'>确认</div>
        </div>
    </div>
</template>
