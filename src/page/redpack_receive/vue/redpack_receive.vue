  ...
  <div class="app" v-if="response">
    ...
    <template v-if="response.code === 0">
      ...
      <div class="wrapper group" v-if="response.data.bonusType == '1'">
        <!--标题-->
        <com-top-title share home :title="response.data.status == '1' ? '已领取～' : '恭喜您获得大礼包～'"></com-top-title>
        <!--信封-->
        <div class="envelope">
          <p>恭喜您获得</p>
        ...
        <div class="redpack-list">
          <img class="arrow" src="http://9i.dvmama.com/free/redpack_receive/group-arrow.png">
        ...
        <!--使用说明-->
        <div class="rule">
          <img class="title" src="http://9i.dvmama.com/free/redpack_receive/rule-title.png">
      ...
      <div class="wrapper random-and-equal" v-if="response.data.bonusType == '0'">
        <!--标题-->
        <com-top-title share home :title="response.data.status == '1' ? '已领取～' : '恭喜您获得红包～'"></com-top-title>
        <!--信封-->
        <div class="envelope">
        ...
        <div class="luck-list" v-if="response.data.competeList && response.data.competeList.length > 0">
          <img class="title" src="http://9i.dvmama.com/free/redpack_receive/luck-title.png">
          <com-scroll-list>
    ...
    <div class="wrapper no-begin" v-if="response.code === 90005">
      <!--标题-->
      <com-top-title share home title="活动未开始～"></com-top-title>
      <!--信封-->
      <div class="envelope">
        <p>活动未开始～</p>
        <p><img src="http://9i.dvmama.com/free/redpack_receive/begin-time.png"></p>
    ...
    <div class="wrapper end" v-if="response.code === 90006">
      <!--标题-->
      <com-top-title share home title="活动已结束～"></com-top-title>
      <!--信封-->
      <div class="envelope">
        <p>活动已结束～</p>
        <p>下次活动，敬请期待～</p>
    ...
    <div class="wrapper no-remain" v-if="response.code === 90001">
      <!--标题-->
      <com-top-title share home title="红包已抢光～"></com-top-title>
      <!--信封-->
      <div class="envelope">
        <p>红包已抢光～</p>
        <p>下次活动，敬请期待～</p>
    ...
    <div class="wrapper no-login" v-if="response.code === 90000">
      <!--标题-->
      <com-top-title share home title="您还未登录～"></com-top-title>
      <!--信封-->
      <div class="envelope">
        <p>您还未登录～</p>
        <p>大V店送你红包抢不停～</p>
      ...
      <a class="btn" @click="login.login();"><p>登录领取</p></a>
      <!--使用说明-->
      <div class="rule">
        <img class="title" src="http://9i.dvmama.com/free/redpack_receive/rule-title.png">
        <div class="rich-text" v-html="response.data.bonusContent"></div>
    ...
    <div class="wrapper no-remain" v-if="response.code === 90010">
      <!--标题-->
      <com-top-title share home title="会员专享红包"></com-top-title>
      <!--信封-->
      <div class="envelope">
        <p>领取失败啦～</p>
        <p>开通会员才能领红包哦~</p>
    ...
    <div class="wrapper error" v-if="isError">
      <!--标题-->
      <com-top-title share home title="出错啦～"></com-top-title>
      <!--出错图标-->
      <div class="error-pic"><img src="http://9i.dvmama.com/free/redpack_receive/error.png"></div>
      <!--文案-->
    ...
    watch: {
      ...
      response(){
        ...
        this.$nextTick(function () {
          ...
          // 设置背景图位置
          if($('.dvd-service-com-title').length > 0) {
