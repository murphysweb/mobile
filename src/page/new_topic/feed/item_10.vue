<template>
  <div>
    <div class="img_container" v-if="environment=='menu'">
      <img src="http://9i.dvmama.com/free/theme_thu_img11.jpg" alt="">
    </div>
    ...
    <div v-if="environment=='show'" class="goods_group_con">
      <a :href="item.url" v-for="(item, index) in previewData" :key="index" class="goods_item">
        <div class="goods_img">
          <!--<x-img v-if="index>3" :src="item.goods_img" default-src="http://9i.dvmama.com/free/2017/06/08/160_160_4d0f1e2009fdfd8bb0c430cda8e22a82.png" container="#vux_view_box_body"></x-img>-->
