<template >
  <div name="item4">
    <div class="img_container" v-if="environment=='menu'">
      <img src="http://9i.dvmama.com/free/2017/01/16/750_580_66b9a8876371d17f0a9509bd9b50de3a.png" alt="">
    </div>
    ...
    <div v-if="environment=='show'" class="goods_group_con">
      <a :href="item.url" v-for="(item, index) in previewData" :key="index" class="cross_goods_item goods_cross">
        <div class="goods_img">
        <!--<x-img v-if="index>6"  :src="item.goods_img" default-src="http://9i.dvmama.com/free/2017/06/08/160_160_4d0f1e2009fdfd8bb0c430cda8e22a82.png" container="#vux_view_box_body"></x-img>-->
