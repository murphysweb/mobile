<!--<template>
  <div style="height:100%;" class="app">
    <view-box ref="viewBox">
      <com-top-title slot="header" :title="title" bottom-line home hide-disable></com-top-title>
...
<template>
  <div style="height:100%;" class="app">
    <view-box ref="viewBox">
      <com-top-title slot="header" :title="title" bottom-line home share hide-disable></com-top-title>
      <feed environment="show" :feed-list="list" ></feed>
    </view-box>
  </div>
</template>
