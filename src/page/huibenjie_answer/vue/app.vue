...
<template>
  <div class="app"
    ...
    <div class="page">
      <!--页面背景-->
      <img class="bg" :src="'http://9i.dvmama.com/free/huibenjie/huibenjie_answer/bg-' + (parseInt((passNo-1) / 3) + 1) + '.jpg'">

      <!--欢呼-->
      <img class="cheer" :src="'http://9i.dvmama.com/free/huibenjie/huibenjie_answer/cheer.png'" v-if="status === 1 || status === 3 || status === 4">

      <!--答题面板-->
      <img class="panel" :src="'http://9i.dvmama.com/free/huibenjie/huibenjie_answer/panel.png'"
           v-if="status === 0 || status === 1 || status === 2 || status === 4 || status === 5">
      <img class="panel" :src="'http://9i.dvmama.com/free/huibenjie/huibenjie_answer/panel-prize.png'" v-if="status === 3">
      ...
      <div class="content">
        ...
        <div class="panel">
          ...
          <template v-if="status === 3">
            ...
            <template v-if="!subjectResponse.data.bonusInfo">
              <!--抽奖按钮-->
              <img class="get-coupon-btn" :src="'http://9i.dvmama.com/free/huibenjie/huibenjie_answer/get-coupon-btn.png'"
        ...
        <!--比拼名单-->
        <div class="pass-list">
          <img class="title-pic" :src="'http://9i.dvmama.com/free/huibenjie/huibenjie_answer/pass-list-title.png'">
          <div class="list">
            <ul ref="pass-list-ul">
