<template>
  <div class='container'>
    <div v-if="is365 == 0" class='guide1'>
      <img src="//9i.dvmama.com/free/2017/06/07/guideBg.png" v-if='!giftButton' class='guide1Bg'>
      <img src="//9i.dvmama.com/free/2017/06/22/success_bg1.png" v-if='giftButton' class='guide1Bg'>
      ...
      <div class='guide1Img guide1all' v-if='bonusFlag'>
        <img src="//9i.dvmama.com/free/2017/06/07/ticket.png" class='guide1all' @click='linkUrl(bonus.linkUrl)'>
    ...
    <!-- 365增书页 -->
    <div v-if="is365 == 1" class='guide1'>
      <img src="//9i.dvmama.com/free/2017/06/28/partner_bg2.png" class='guide1Bg'>
      <div class='exit' @click='goProfile'></div>
      <div class='guide1Title guide1all'>您已成功为宝宝订阅了一年 <br> “小书库”</div>
      <div class='guide1Content guide1all' style="color: #BF9D51;font-size: .14rem;margin-top:0.1rem;">并成为大V店会员，即将开启您的亲子阅读之旅</div>
      <div class='guide1Img guide1all' style="height: 1.29rem;top:2.3rem;">
        <img src="//9i.dvmama.com/free/2017/10/28/iStock.png" style="width: 1.94rem;height: 1.29rem;" class='guide1all'>
      </div>
      <!-- <a href="/book_stacks.html" class='guide1Btn guide1all' style="top: 3.67rem;">去领取本月的书</a> -->
      <span @click="openbroswer" class='guide1Btn guide1all' style="top: 3.67rem;">去领取小书库童书</span>
    </div>
    ...
    <div class='guide3' v-if='goodsList'>
      <div v-if='goodsList' class='guide3Container' @click='linkUrl(goods.linkUrl)' v-for='goods in goodsList'>
        ...
        <div class='guide3price'>
          ...
          <img src="//9i.dvmama.com/free/2017/06/22/activityBg1.png">
        </div>
  ...
  export default {
    ...
    methods: {
      ...
      wxshare() {
        ...
        shareInfo.imgUrl =
          "http://pic.vyohui.cn/free/2017/06/16/800_800_6c36fd66f4c95aa7d0e4d7b00cb05667.png?x-oss-process=image/resize,m_fill,w_100,h_100/quality,Q_90&";
        ...
        axios
          ...
          .then(function(respone) {
            if (respone.data.code == 0) {
              that.is365 = respone.data.data.is_365kd;
              ...
              if (
                respone.data &&
                respone.data.data &&
                respone.data.data.giftButton
              )
                that.giftButton = respone.data.data.giftButton;
              if (
                respone.data &&
                respone.data.data &&
                respone.data.data.goodsList
              )
      ...
      go_get_books() {
        window.location.href = "/book_stacks.html";
      },
      openbroswer() {
        let ts = this;
        try {
        ...
        if (ts.app) {
          native.Browser.open({
            url: location.origin + '/book_stacks.html'
...
<style>
  body {
    background: url(//9i.dvmama.com/free/2017/06/24/partner_bg2.png);
  }
</style>
