<template>
  <div class='container'>
    <div v-if="is365 == 0" class='guide1'>
      <img src="//9i.dvmama.com/free/2017/06/28/partner_bg2.png" v-if='!giftButton' class='guide1Bg'>
      <img src="//9i.dvmama.com/free/2017/06/28/partner_bg1.png" v-if='giftButton' class='guide1Bg'>
    ...
    <div v-if="is365 == 1" class='guide1'>
      ...
      <span @click="openbroswer" class='guide1Btn guide1all' style="top: 3.67rem;">去领取本月的书</span>
    </div>
