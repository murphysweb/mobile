...
<template>
  <div class="activity_container">
    <div class="activity_huibenjie_scratch">
      <!--刮免单背景图-->
      <img class="bg-pic" src="//9i.dvmama.com/free/scratch-bg-1018.png"
           v-if="window.isShowLottery === '1'">
      <!--刮现金背景图-->
      <img class="bg-pic" src="//9i.dvmama.com/free/huibenjie/scratch/scratch-bg-money.png"
           v-if="window.isShowLottery === '2'">
      <!--刮奖-->
      <com-scratch-card :show-mask="showMask" :can-scratch="valid" mask-tip="" mask-img="//9i.dvmama.com/free/scratch-mask-1018.png" font-size="30px" font-color="#e7e7e7"
        ...
        <template v-if="window.isShowLottery === '1'">
          <img class="result-bg" src="//9i.dvmama.com/free/scratch-yes-1018.png" v-if="window.isFreeOfCharge === '1'">
          <img class="result-bg" src="//9i.dvmama.com/free/scratch-no-1018.jpg" v-else>
        </template>
        <!--现金刮刮卡文案-->
      ...
      <div class="rule" v-if="window.isShowLottery === '1'">
        <p class="title">抽免单活动规则：</p>
        <p>1、活动时间：2018.7.10-2018.7.14；</p>
        <p>2、该活动仅大V店会员用户可以参加；</p>
        <p>3、活动期间，用户完成订单支付后，即有1次免单抽奖的机会，如抽中免单，则免当前订单的实际支付金额（包含返现支付部分）；</p>
        <p>4、免单奖励将于8月8日24点前发放，会员以返现形式返至【我的】-【总额】-【可提现金额】-【其他收入】中；</p>
        <p>5、开通会员订单、小书库订单、组团订单、398元大礼包订单以及代付订单不参与该活动；</p>
        <p>6、违规处理：如遇退货，相应免单奖励予以取消；</p>
        <p>7、详情可咨询大V店客服。</p>
      </div>
      <!--刮现金规则-->
