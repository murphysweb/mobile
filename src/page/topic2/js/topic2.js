 ...
 **/
 function backToTop(){
  ...
  b2t.src="//9i.dvmama.com/free/back_top_icon_0803.png";
    ...
    var str = '<div class="goods_group">';
        for (var i = 0; i < data.length; i++) {
          ...
          str += '<div class="goods_item">' +
            ...
            '<div class="goods_img">' +
            (i<4?('<img src=\"'+d.goods_img+'\">'):('<img src="http://9i.dvmama.com/free/loading_320_320_v2.png" data-original=\"' + d.goods_img + '\">'))+
