<template>
  <div class="order_list_container">
    <div class="order_list_switcher dav-shadow">
      ...
      <div :class="{'selected':selected==2}" @click='delivery' class="switcher_item" data-type="2"><span>待发货</span>
      </div>
      <div :class="{'selected':selected==1}" @click='unget' class="switcher_item" data-type="1"><span>待收货</span></div>
      <div :class="{'selected':selected==4}" @click='completed' class="switcher_item" data-type="4"><span>待评价</span>
      </div>
    </div>
...
<script>
  var ua = require('../../../common/js/module/ua.js').default;
