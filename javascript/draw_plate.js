                                ...
                                setTimeout(function () {
                                    if (result.data.status == 1) {
                                        ...
                                        if (result.data.prize == "p_four") {
                                            prize = 4;
                                            imgs = "//9i.dvmama.com/free/2017/kaidianchoujiang20170221/red10.png";
                                            txts = "获得5元红包和5元包邮券";
                                        }
                                        ...
                                        if (prize == num) {
                                            ...
                                            setTimeout(function () {
                                                ...
                                                if (result.data.prize != "none") {
                                                    var html = '<img src="//9i.dvmama.com/free/2017/kaidianchoujiang20170221/'+result.data.prize+'.png"><p>' + txts + '</p>';
                                                    $(".get_gift").html(html);
