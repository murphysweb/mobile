$(function () {
    ...
    function init() {
        ...
        img.src = "//9i.dvmama.com/free/2016/11/29/l2.png";

        $(document.body).append($('<audio src="//9i.dvmama.com/free/duang2.mp3" preload id="music"></audio>'));
    }
    ...
    function addLang(x, y) {
        var clicked = false;
        var dom = $('<div class="lang"><img src="//9i.dvmama.com/free/2016/11/29/l.png" alt=""></div>');
        $(".game").append(dom);
        ...
        dom.find("img").on("touchstart click", function (e) {
            ...
            dom.data("clicked", 1);
            clicked = true;
            $(this).css("animation-play-state", "paused").attr("src", '//9i.dvmama.com/free/2016/11/29/l2.png');
            setTimeout(function () {
    ...
    function stop() {
        $(".btn2").removeClass("hide").addClass("stop").find("img").attr("src", '//9i.dvmama.com/free/2016/11/28/button4.png');
    ...
    function alertSuccess(data, clickNum) {
        ...
        var $use = $('<div class="use"> <img src="//9i.dvmama.com/free/2016/11/29/use.png" alt="">' +
