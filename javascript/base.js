...
$(document).ready(function() {
  ...
  window.bravetime.callAppShare = function(opt) {
    if (Units.isApp() && Units.isIOS() && Units.getAppVersion() === 570){
         bravetime.callAppShareInfo(-1);
    }else{
      bravetime.callNative(
        function() {
...
(function() {
  ...
  if (
    ...
    location.href.indexOf("/index.php?c=VipUserSelectBooks&a=vip_user_select_book") !== -1 ||
    location.href.indexOf("/index.php?c=VipUserSelectBooks&a=vip_user_address_list") !== -1 ||
    location.href.indexOf("/index.php?c=VipUserSelectBooks&a=vip_user_edit_address") !== -1 ||
    location.href.indexOf("/index.php?c=VipUserSelectBooks&a=vip_book_add_address") !== -1 ||
