...
var mySwiper = new Swiper ('.swiper-container', {
	...
	function bindClick (obj, href) {
		for (var i = 0;i<obj.length;i++) {
			obj[i].onclick = function () {
				this.src = '//9i.dvmama.com/free/2016/12/24/tree/page6_btn1a.png'
				var that = this
				setTimeout(function () {
		            ...
		            function kd(useCode,code){
					    ...
					    $.ajax({
					        ...
					        error:function(){
					            ...
					            // kd_btn.removeClass("btn-disable").find("span").html("立即开店");
					            bravetime.ajaxError(15);
					            that.src = '//9i.dvmama.com/free/2016/12/24/tree/page6_btn1b.png'
					        }
					    });
					}
	...
	var img_url = '//9i.dvmama.com/user/2016/06/06/80_80_3ac6f90599265841db4f48c0c6a73e89.png'
	var img = new Image()
	img.src = img_url
	img.onload = function(){
...
function changeSrc (arr, num) {
	var str = '//9i.dvmama.com/free/2016/12/24/tree/number_'
	for (var i = 0 ; i < arr.length; i++) {
		arr[i].src = str + num + '.png'
	}
}
function changeSrc1 (arr, num) {
	var str = '//9i.dvmama.com/free/2016/12/24/tree/num_'
	for (var i = 0 ; i < arr.length; i++) {
		arr[i].src = str + num + '.png'
	}
}
function getLevel() {
	...
	for (var i = 0;i<page1_peacock.length;i++) {
		if (window.people <=0) {
			page1_peacock[i].src = '//9i.dvmama.com/free/2016/12/24/tree/page1_bee.png'
		} else if (window.people >0 && window.people<20) {
			page1_peacock[i].src = '//9i.dvmama.com/free/2016/12/24/tree/page1_butterfly.png'
		}else if (window.people >=20 && window.people<50) {
			page1_peacock[i].src = '//9i.dvmama.com/free/2016/12/24/tree/page1_peacock.png'
		}else if (window.people >= 50){
			page1_peacock[i].src = '//9i.dvmama.com/free/2016/12/24/tree/page1_phenix.png'
		}
	}
}
getLevel()
window.onload = function(){
  ...
  setInterval(function () {
  	if (page4_eye.getAttribute('num') == 1) {
	  	...
	  	page4_eye.src='//9i.dvmama.com/free/2016/12/24/tree/page4_eye2.png'
	  } else {
	  	page4_eye.setAttribute('num', 1)
	  	page4_eye.src='//9i.dvmama.com/free/2016/12/24/tree/page4_eye1.png'
	  }
  }, 1000)
}
