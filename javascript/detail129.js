$(document).ready(function(){
    ...
    if(d129 && d129.length){
        ...
        kd_btn.click(function(event) {
          ...
          if(Units.isIOS() && Units.isApp() && Units.getAppVersion() >= 530) {
            return;
          }
...
$(function(){
  ...
  var result = /\/(\d+)\//.exec(link.href);
  var version = result[1];
  var pre_path = link.href.split('stylesheet')[0];
  ...
  // detail129_webpack
  var script = document.createElement('script');
  script.src = pre_path+'dist/detail129_webpack.js';
  document.body.appendChild(script);
})
