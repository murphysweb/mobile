  ...
  function showIosInterface() {
    ...
    window.iosInterface.getShareInfo = function() {
      var shareInfo = {
        ...
        imgUrl: window.imgUrl || '//9i.dvmama.com/goods/1/20151017104524.png'
      };
