    ...
    function getsuperData(){
        $.ajax({
            ...
            success: function (result) {
                ...
                '<img src="//9i.dvmama.com/free/2016/11/02/93_54_5144504e0c449458f60cf8eff809798c.png" alt="" width="15%" style = "position: relative;top: -2px;left: 2px;">' +
                            ...
                            success: function (result) {
                                if(result.code == -1){
                                    ...
                                    if(result.data.bonus_type_id==1416){
                                        ...
                                        $("#show_message")[0].src = "//9i.dvmama.com/free/2016/11/02/1130_443_27d0d56e3500163fffb1d4130867dec6.png";
                                        rotateFunc(1,334.1);
                                    ...
                                    if(result.data.bonus_type_id==1417){
                                        ...
                                        $("#show_message")[0].src = "//9i.dvmama.com/free/2016/11/02/443_174_20782fb60556a3aa16a1b52c4ce3ba76.png";
                                        rotateFunc(2,282.7);
                                        awardstext = result.data.bonus_name;
                                    }
                                    if(result.data.bonus_type_id==1415){
                                        $(".look :eq(0)").css("display","block");
                                        $(".look :eq(1)").css("display","none");
                                        $("#show_message")[0].src = "//9i.dvmama.com/free/2016/11/02/1130_443_bafa3a7baa4efb9dcbef45e405f6df8c.png";
                                        rotateFunc(3,231.3);
                                        awardstext = result.data.bonus_name;
                                    }
                                    if(result.data.bonus_type_id==1419){
                                        ...
                                        $(".look :eq(0)").css("display","none");
                                        $("#go")[0].href = result.data.url;
                                        $("#show_message")[0].src = "//9i.dvmama.com/free/2016/11/02/443_174_9c866cb5ed0200ecf2b30426972b24d4.png";
                                        rotateFunc(4,179.9);
                                        awardstext = result.data.bonus_name;
                                    }
                                    if(result.data.bonus_type_id==1414){
                                        $(".look :eq(0)").css("display","block");
                                        $(".look :eq(1)").css("display","none");
                                        $("#show_message")[0].src = "//9i.dvmama.com/free/2016/11/02/1130_443_48bd1d7be8ce78abb83cf2ce72e56be7.png";
                                        rotateFunc(5,128.5);
                                        awardstext = result.data.bonus_name;
                                    }
                                    if(result.data.bonus_type_id==1418){
                                        ...
                                        $(".look :eq(0)").css("display","none");
                                        $("#go")[0].href = result.data.url;
                                        $("#show_message")[0].src = "//9i.dvmama.com/free/2016/11/02/443_174_0262d0dfb0ac6f0e7e85c72a3324c10a.png";
                                        rotateFunc(6,77.1);
                                        awardstext = result.data.bonus_name;
                                    }
                                    if(result.data.bonus_type_id==1413){
                                        $(".look :eq(0)").css("display","block");
                                        $(".look :eq(1)").css("display","none");
                                        $("#show_message")[0].src = "//9i.dvmama.com/free/2016/11/02/1130_443_8918cd26685f2ccf5584e165f6c3146c.png";
                                        rotateFunc(7,25.7);
                                        awardstext = result.data.bonus_name;
                                    }
                                }
