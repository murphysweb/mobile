<template>
  <div>
    <div class="mian_bg">
      ...
      <img src="//9i.dvmama.com/free/2017/05/17/main_pic.png" alt="">
      <!--<img src="//9i.dvmama.com/free/2017/05/17/main_pic.jpg" alt="">-->
      <div class="start_play" v-on:click="init_play(1)" style="right:12.1%;">
        <img src="//9i.dvmama.com/free/2017/05/18/dot_shank_tran.png" alt="">
      </div>
    ...
    <div @touchmove.prevent="prevent_move" v-if="shows" class="playchildren_wrap">
      <div class="playchildren">
        <img class="play" v-if="accessrun&&canPlay" v-on:click="begin" src="//9i.dvmama.com/free/2017/05/15/start.png"
             alt="">
        <img class="play" v-show="accessrun&&!canPlay" @click="close"
             src="//9i.dvmama.com/free/2017/05/18/fivetimeover.png"
             alt="">
        <div class="title_bottom">
          <img src="//9i.dvmama.com/free/2017/05/15/caicaikan_title.png" alt="">
        ...
        <transition-group v-if="shows" :name="'flip-list'+flips" tag="ul">
          <li class="card" v-for="(item,index) in items" v-bind:key="item">
            ...
            <div v-if="item == rewardNum" class="card_img" :class="{shank_redss:!not_started}" @click="reward" alt="1">
              <img src="//9i.dvmama.com/free/2017/05/18/tran_door.png" alt="">
            </div>
            <!--//未中奖的-->
        ...
        <div class="title_bottom">
          <img class="title_bottom" src="//9i.dvmama.com/free/2017/05/15/trans.png" alt="">
    ...
    <div @touchmove.prevent="prevent_move" v-if="show_rule" class="playchildren_wrap">
      <div class="playchildren">
        <img src="//9i.dvmama.com/free/2017/05/18/rule_new.png" alt="">
    ...
    <div @touchmove.prevent="prevent_move" v-if="result" class="result_wrap">
      <div v-if="flips < 5" class="result_in">
        <img src="//9i.dvmama.com/free/2017/05/15/regret1.png" alt="">
        <img @click="init_play(2)" class="tips_btn" src="//9i.dvmama.com/free/2017/05/15/regret_tips1.png" alt="">
      </div>
      <div v-else class="result_in">
        <img src="//9i.dvmama.com/free/2017/05/15/regret1.png" alt="">
        <img @click="close" class="tips_btn2" src="//9i.dvmama.com/free/2017/05/15/regret_tips2.png" alt="">
      </div>
    </div>
    <div @touchmove.prevent="prevent_move" v-show="result2" class="result_wrap">
      <div class="result_in">
        <img src="//9i.dvmama.com/free/2017/05/18/get_red3.png" alt="">
...
<style scoped>
  ...
  .playchildren ul {
    ...
    overflow: hidden;
    background-image: url("//9i.dvmama.com/free/2017/05/15/c_bg.png");
  ...
  .card_img {
    ...
    background-image: url("//9i.dvmama.com/free/2017/05/15/doors.png");
  }

  .card_img.card_img2 {
    background-image: url("//9i.dvmama.com/free/2017/05/15/doorsno.png");
  }
  ...
  @keyframes myredshankss {
    from {
      background-image: url("//9i.dvmama.com/free/2017/05/17/shank1.png");
    }
    to {
      background-image: url("//9i.dvmama.com/free/2017/05/17/shank2.png");
    }
  }
  ...
  .get_continue {
    ...
    right: 0;
    margin: auto;
    background-image: url("//9i.dvmama.com/free/2017/05/18/cont.png");
  }

  .get_continue.over {
    background-image: url("//9i.dvmama.com/free/2017/05/18/Ikonw.png");
  }
  ...
  @keyframes myredshank {
    from {
      background-image: url("//9i.dvmama.com/free/2017/05/15/doors1.png");
    }
    to {
      background-image: url("//9i.dvmama.com/free/2017/05/15/doors2.png");
    }
  }
