...
<style>
    .dav_icon_cart_44_40{
        ...
        background-image: url("//9i.dvmama.com/free/new_shoppingCartBtm_0803.png");
    }

    .dav_icon_cart_44_40.active{
        background-size: 24px;
        background-image: url("//9i.dvmama.com/free/new_shoppingCartBtmActive_0803.png");
    }
    .dav_icon_home_44_40{
        background-size: 24px;
        background-image: url("//9i.dvmama.com/free/new_home_0803.png");
    }
    .dav_icon_home_44_40.active{
        background-size: 24px;
        background-image: url("//9i.dvmama.com/free/new_homeActive_0803.png");
    }

    .dav_icon_me_44_40{
        background-size: 24px;
        background-image: url("//9i.dvmama.com/free/new_mine_0803.png");
    }

    .dav_icon_me_44_40.active{
        background-size: 24px;
        background-image: url("//9i.dvmama.com/free/new_mineActive_0803.png");
    }
    ...
    .dav_icon_search_44_40{
        ...
        margin-left: 2px;
        margin-top: 1px;
        background-image: url("//9i.dvmama.com/free/2017/05/11/footer_course1.png");
    }
    ...
    .dav_icon_search_44_40.active{
        ...
        margin-left: 2px;
        margin-top: 1px;
        background-image: url("//9i.dvmama.com/free/2017/05/11/footer_course2.png");
    }
</style>
<script>
    export default{
