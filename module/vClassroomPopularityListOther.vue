...
<template>
    <div>
        <div class="list_top">
            <div class ="other" v-if="topList[0]">
                <div class="other_image">
                    ...
                    <img class="top_three" src="//9i.dvmama.com/free/2016/12/21/144_32_bd67acb047a39393a241c38737b23105.png" alt="">
                </div>
            ...
            <div class ="other"  v-if="topList[1]">
                <div class="other_image">
                    ...
                    <img class="top_three" src="//9i.dvmama.com/free/2016/12/21/144_36_fcf2cf34fa22e3218d62052fe8ad63c9.png" alt="">
                </div>
                <div class="other_message">
            ...
            <div class ="other"  v-if="topList[2]">
                <div class="other_image">
                    ...
                    <img class="top_three" src="//9i.dvmama.com/free/2016/12/21/144_32_764dc74bb6b60fc1c4eddb4bad998724.png" alt="">
                </div>
                <div class="other_message">
        ...
        <div v-if="no_data" style="text-align: center;position: relative;top: 80px;">
            <img style="width:18%;" src="//9i.dvmama.com/free/2016/12/19/200_298_0d6a638b6549b3dba2ab709ac72a3db1.png" alt="">
...
//                                            scope.more = data.data.dataList.more;
            ...
            scroll:function(){
                ...
                $(window).scroll(function(){//滚动条滚动事件
                  ...
                  let lessH = offsetTop-offset-window.screen.availHeight
                  let maxH = 100;
                  if(scope.list.length >=37){
                    maxH = 10
                  }else if(scope.list.length >=57){
                    maxH = 1
                  }
                    if(lessH<maxH && offsetTop > window.screen.availHeight && scope.loading === false){//如果滚动条到一定位置
                      scope.getData(false);
                    }
            ...
            imgObject:function (imgSrc) {
                if(imgSrc){
                    ...
                    return '//9i.dvmama.com/free/2016/12/30/160_160_b879eb6581e8b159e0d35fe485011db3.png'
                }
            },
        },
        watch: {
