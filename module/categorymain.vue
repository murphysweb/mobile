<template>
    <div class="box box-h con">
      <com-top-title title="分类列表" v-if="ua.isDvdApp() && ua.compareVersion(ua.getDvdAppVersion(), '5.2.0') >= 0"></com-top-title>
...
//
          ...
          if(ua.isDvdApp() && ua.compareVersion(ua.getDvdAppVersion(), '5.2.0') >= 0) {
            var interval = setInterval(function(){
              var dom = document.querySelector('body.in_app .con');
              if(dom){
                dom.style.paddingTop = '44px';
