    ...
    export default {
        ...
        data(){
            return {
            	...
            	curcleFullHash:{},
            	length:null,
                defaultAvatar:'//9i.dvmama.com/free/2016/12/30/160_160_b879eb6581e8b159e0d35fe485011db3.png',
            }
        },
        created(){
      ...
      li{
        ...
        .right {
          ...
          .noPlay .fa:after {
            ...
            z-index: 100;
            height: 17px;
            background: url('//9i.dvmama.com/free/2016/12/24/22_32_16dffc36683debdbbf6a813306594422.png') no-repeat;
          ...
          .play .fa:after {
            ...
            position: absolute;
             ...
             z-index: 100;
             height: 20px;
             background: url('//9i.dvmama.com/free/2017/02/27/playVoice.gif') no-repeat;
      ...
      .myself{
        ...
        .right {
          ...
          .play .fa:after {
            ...
            z-index: 100;
            height: 13px;
            background: url('//9i.dvmama.com/free/voice_img_311.gif') no-repeat;
            background-size: 12px;
          }
          .main:before {
            width: 0;
