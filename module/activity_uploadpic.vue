    ...
    <div>
        <div v-if="uploadPic">
            <div class="add_pic_con clearfix">
                <ul>
                    ...
                    <li v-if="piclist.length<9" class="add">
                        <img src="//9i.dvmama.com/free/2017/03/04/226_226_39a845ac50733d086a5d56b4629d8315.png">
            ...
            <div class="sample">
                ...
                <img src="//9i.dvmama.com/free/2017/03/06/710_476_5ab16a0ff48e0aaca184414f2e9d1587.png">
            </div>
        ...
        <div v-if="uploadPicSuccess" class="uploadPicSuccess">
             <div class="con">
                 <p><img src="//9i.dvmama.com/free/2017/03/06/100_100_131a31ec73db757676a04c2020a740a6.png"></p>
...
<style>
    ...
    .publish_pic_preview_bottom .delete_btn {
        ...
        right: 0;
        padding: 11px;
        background: url(//9i.dvmama.com/free/comment_delete_icon.png) no-repeat center;
        width: 22px;
        height: 22px;
    ...
    export default{
        data(){
            return {
                ...
                piclist: [],
                loadimgurl: "//9i.dvmama.com/free/2017/03/06/226_226_d7f04ca4fc15f3f1bdb56a465cbbe906.gif",
                pic_view: false,
            }
        },
        watch:{
