...
<style>
    ...
    .upload_container .close {
        ...
        height: 20px;
        background-size: 100%;
        background-image: url(//9i.dvmama.com/free/close_btn_0829.png);
    }
    /*Retina屏为2的时候调用下面的样式*/
    @media
    ...
    export default{
        data(){
            return{
                addressee:'',
                idcardNumber:'',
                cardHead:'//9i.dvmama.com/free/2017/02/24/304_200_ae8ece835b2cc45c268cd26afcac7612.jpg',
                cardTail:'//9i.dvmama.com/free/2017/02/24/304_200_18de8666e1fd08c8b04d7a8717974074.jpg',
                uploadcardHead:0,
                uploadcardTail:0,
            }
        },
        ...
        methods:{
           ...
           onFileChange(e,name){
               ...
               if(files.length){
                   //上传图片进度条
                   that[name]="//9i.dvmama.com/free/2017/03/01/304_200_5ed94acf11f8a6fb57e1138bea19dccd.gif";
            ...
            submit(){
                ...
                $.ajax({
                    ...
                    data:layout.strSign('mayYouLike',obj),
                    dataType:"json",
                    type:'POST',
