...
<template>
    <div>
        ...
        <!--banner图片-->
        <img ref="biubiu" id="bannerImg" src="//9i.dvmama.com/free/2017/01/16/750_300_2197441ac752452501ed3b946c14f129.png" alt="">
        <!--三个icon-->
            ...
            <a v-for="(item,index) in list" :href="a_href(item.goods_id)">
                <div style="position: relative;background-color: #FFFFFF;height: 140px;">
                    <div style="position: relative;max-width: 40px;height: 100%;">
                        ...
                        <img v-if="index == 0" style="max-width: 21px;position: absolute;left: 50%;top: 50%;margin-left: -10px;margin-top: -10px;" src="http://9i.dvmama.com/free/2017/01/09/42_56_5776adc9320e1fa61aee0552a87380ee.png" alt="">
                        <img v-if="index == 1" style="max-width: 21px;position: absolute;left: 50%;top: 50%;margin-left: -10px;margin-top: -10px;" src="http://9i.dvmama.com/free/2017/01/09/42_56_eb3f4265cd02b9c7dc93d11e457b06e3.png" alt="">
                        <img v-if="index == 2" style="max-width: 21px;position: absolute;left: 50%;top: 50%;margin-left: -10px;margin-top: -10px;" src="http://9i.dvmama.com/free/2017/01/09/42_56_606405af49064a5909679a4b4eb86f45.png" alt="">
                        <img v-if="index >= 3" style="max-width: 21px;position: absolute;left: 50%;top: 50%;margin-left: -10px;margin-top: -10px;" src="http://9i.dvmama.com/free/2017/01/09/46_44_515f0f4ed882b1b47e309aab15c37723.png" alt="">
                    </div>
        ...
        <div v-if="loading" class="no_more"> 加载中 <img src="//9i.dvmama.com/free/loading_03252.svg"></div>
...
//                                        scope.all_more[currentType] = true;
            ...
            imgObject:function (imgSrc) {
                return{
                    src: imgSrc || '//9i.dvmama.com/free/2017/01/09/92_92_d44e21cb668d116859b8916ce041e5bf.png',
                    error: '//9i.dvmama.com/free/2017/01/09/92_92_d44e21cb668d116859b8916ce041e5bf.png',
                    loading: '//9i.dvmama.com/free/2017/01/09/92_92_d44e21cb668d116859b8916ce041e5bf.png'
                }
            },
