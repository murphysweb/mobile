<template>
    <div>
        ...
        <div v-if="!list.length && requestSuccess==true" class="idcard_none">
            <div class="img"><img
                    src="//9i.dvmama.com/free/2017/02/22/236_194_60d8471d13f3d8f76a67188f53ff8787.png">
            </div>
...
.idcardList li .delete .delete_btn .delete_icon{
    width:16px;
    height: 18px;
    background: url("//9i.dvmama.com/free/2017/02/22/32_36_e47057e83a51dfc652ffa9fb2d63a1dd.png") no-repeat;
