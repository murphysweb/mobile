    ...
    <div id='comment'>
        ...
        <div class='addImgtext'>
            <div class='imgContainer' v-for='(item, index) in imgList' @click='showImg(index,imgList,item)'>
                <img v-if='!item' src="//9i.dvmama.com/free/2017/08/02/page3.png" class='maskPage'>
                <img v-if='item' :src="item" class='maskPage'>
                <img v-if='item' @click='delImg(index)' class='addImgTextDel' src="//9i.dvmama.com/free/2017/08/03/del.png">
            </div>
            <div class='imgContainer' v-if='imgList.length < 9'>
                <img src="//9i.dvmama.com/free/2017/08/02/addImg.png" class='img'>
    ...
    export default{
        data:function(){
            return{
                ...
                userId: 931126,
                newAlert:false,
                starImg:'//9i.dvmama.com/free/2017/08/03/zeroStarActive.png',
        ...
        methods:{
            ...
            starImg_btn1(){
                this.starIndex = 1
                this.starImg = '//9i.dvmama.com/free/2017/08/03/oneStarActive.png'
            },
            starImg_btn2(){
                this.starIndex = 2
                this.starImg = '//9i.dvmama.com/free/2017/08/03/twoStarActive.png'
            },
            starImg_btn3(){
                this.starIndex = 3
                this.starImg = '//9i.dvmama.com/free/2017/08/03/threeStarActive.png'
            },
            starImg_btn4(){
                this.starIndex = 4
                this.starImg = '//9i.dvmama.com/free/2017/08/03/fourStarActive.png'
            },
            starImg_btn5(){
                this.starIndex = 5
                this.starImg = '//9i.dvmama.com/free/2017/08/03/fiveStarActive.png'
            },
            back(){
