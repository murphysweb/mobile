<style>
    ...
    .logo_left {
        ...
        background-size         : 100%;
        background-image        : url('//9i.dvmama.com/free/mama0806.png');
    }
    ...
    .logo_right {
        ...
        -webkit-background-size : 100%;
        background-size         : 100%;
        background-image        : url('//9i.dvmama.com/free/plus_0808.png');
    }
...
<template>
    ...
    <div v-if="has_more&&loading" class="no_more">
        加载中 <img src="//9i.dvmama.com/free/loading_03252.svg">
    </div>
</template>
