<style>
    #change_user_img {
        /*background-image: url(//9i.dvmama.com/free/2016/11/09/750_320_c1aa09dd2e5e95cb41089b671d3db764.png);*/
        background-image: url(//9i.dvmama.com/free/2017/03/19/introduce_bg.png);
        padding: 51px 0 30px;
    ...
    <div>
        <div id="change_user_img">
            ...
            <div class='attention_all'>
                <img src="//9i.dvmama.com/free/2017/05/09/attention1.png" v-if='attention==0' @click='attention_yes'>
                <img src="//9i.dvmama.com/free/2017/05/09/attention2.png" v-if='attention==1' @click='attention_no'>
            </div>
        </div>
    ...
    export default{
        ...
        methods:{
            imgObject:function (imgSrc) {
                return{
                    src: imgSrc || '//9i.dvmama.com/free/2016/12/30/160_160_b879eb6581e8b159e0d35fe485011db3.png',
                    error: '//9i.dvmama.com/free/2016/12/30/160_160_b879eb6581e8b159e0d35fe485011db3.png',
                    loading: '//9i.dvmama.com/free/2016/12/30/160_160_b879eb6581e8b159e0d35fe485011db3.png'
                }
            },
            attention_yes(){
                var that = this
