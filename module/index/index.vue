<template>
  <div class="index_inner">
    ...
    <!--内容-->
    <index-feed :data="feedData" v-if='!loadFlag && !unLoadFlag'>
    </index-feed>
    ...
    <div class="other_info">
      ...
      <div v-on:click='clickAdvert1' class='mask_activity1' v-if='advertFlag[0] && advert.topBar' :style="{'background': 'url(' + advert.topBar.imageUrl + ') no-repeat center' , 'background-size': 'cover'}"></div>

      <div class='mask_activity2_f' v-if='advertFlag[1] && advert.layer'>
        <div class='mask_activity2' v-on:click='clickAdvert2' :style="{'background': 'url(' + advert.layer.imageUrl + ') no-repeat center' , 'background-size': 'contain'}">
      ...
      <div class='mask_sign' v-if='advertFlag[2]' :style="{'background': 'url(' + signData.sign.imageUrl + ') no-repeat' , 'background-size': 'cover'}">
      ...
      <div class="downAppWrap" v-if="iftips&&!app" v-on:click="closeTips">
        <div class="downApp" v-on:click.stop="events">
          <img v-if="isWechart" src="//9i.dvmama.com/free/2017/06/13/index_erweima.png">
          <img v-else src="//9i.dvmama.com/free/2017/06/13/index_erweima.png" alt="" @touchstart="tipstouchstart" @touchmove="tipstouchmove" @touchend="tipstouchend">
      ...
      <div class="getReward" v-if="getRewardtips && rewardData.imgUrl != ''">
        <a :href="rewardData.command.content">
          ...
          <!--<img src="http://9i.dvmama.com/goods/2017/06/06/800_384_b7862b07fef7e7dcd0c806e5e648f542.jpg" alt="">-->
