...
// 最近在听
import * as bd_course_last_listen from './feed/bd_course_last_listen.vue';
// 为您推荐
import * as bd_course_recommand from './feed/bd_course_recommand.vue';
// 免费星课
import * as bd_course_free_recommand from './feed/bd_course_free_recommand.vue';
// 第一节课
import * as bd_course_start_first from './feed/bd_course_start_first.vue';
// 4-5个icon
import * as bd_580icon_5 from './feed/bd_icon_item.vue';
// 督导课
import * as bd_supervisor_img_1 from './feed/bd_course_supervisor.vue';
// tiplist
import * as bd_course_index_recommend_category from './feed/bd_course_index_recommend_category.vue';
// 选择标签展示单节课列表
import * as bd_course_tipCourseList from './feed/bd_course_tipCourseList.vue';
...
export default {
  ...
  components: {
    ...
    bd_album_03,
    bd_study_0,
    bd_course_last_listen,
    bd_course_recommand,
    bd_course_free_recommand,
    bd_course_start_first,
    bd_580icon_5,
    bd_supervisor_img_1,
    bd_course_index_recommend_category,
    bd_course_tipCourseList
  }
};
