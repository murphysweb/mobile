            ...
            if (this.isApp){
                if (this.getAppVersion()<410){
                    ...
                    native.VoiceLive.callAppEnterAllNote(
                      {
                        courseId:window.courseId,
                        webUrlAllNote:'/m/allDiscuss.html?courseId=' + window.courseId +'&flag=1&rp=course_detail&rl=notes',
                        webUrlMyNote:'/m/allDiscuss.html?courseId=' + window.courseId + '&rp=course_detail&rl=notes',
                      })
                }

            } else {
                window.location.href = 'https://' + location.host + '/m/allDiscuss.html?courseId=' + window.courseId + '&flag=1&rp=course_detail&rl=notes'
            }
