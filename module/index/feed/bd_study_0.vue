<template>
  <div class="con" @click="go_landing">
    ...
    <!--<div class="big_img">-->
      ...
      <!--<div class="list_line"></div>-->
      <!--<div class="fixed"><div style="color:#333333;font-size: 12px;">更多</div><div class="arrow"><img src="//9i.dvmama.com/free/2017/08/16/entry.png" alt=""></div></div>-->
    <!--</div>-->
    <div class="all">
      <div class="list_all" v-for="item in dataList">
        <div class="list">
          ...
          <div class="list_right" v-if="item.isPlay==1">
            <div class="mask_stop" @click.stop="go_play(item.albumId,item.sortNo)" v-if="( item.albumId==albumId && item.sortNo==sortNo && btnStatus==1)"><img src="//9i.dvmama.com/free/2017/08/28/listSuspend.png" alt=""></div>
            <div class="mask_play" @click.stop="go_play(item.albumId,item.sortNo)" v-if="!( item.albumId==albumId && item.sortNo==sortNo && btnStatus==1)"><img src="//9i.dvmama.com/free/2017/08/28/listPlay2.png" alt=""></div>
