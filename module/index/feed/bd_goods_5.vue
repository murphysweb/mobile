          ...
          <div class="swiper-wrapper">
            ...
            <div v-if="data.body.more" class="detail swiper-slide" style="width: 124.382px;">
              <a :href="data.body.command.content" position="more">
                <div class="goods_img_size">
                  <img src="//9i.dvmama.com/free/2016/12/20/300_300_2f12c4229c5444864431d2cd8cd1bdb3.jpg">
                </div>
              </a>
            </div>
          </div>
...
<style lang="sass" rel="stylesheet/scss" scoped>
  ...
  .limitTag{
    height: 16px;
    background: url(//9i.dvmama.com/free/2017/06/07/limitTag.png) 0 0 no-repeat;
