      ...
      <div class="flist" v-for="(item,index) in dataList">
        <div class="list" @click.stop="go_href(item.albumId,item.sortNo,item.command.content)">
          ...
          <div class="right_img" v-if="item.isPlay==1">
            <div class="mask_stop" @click.stop="go_play(item.albumId,item.sortNo)" v-if="(item.sortNo==sortNo && item.albumId==albumId && btnStatus==1)"><img src="//9i.dvmama.com/free/2017/08/28/listSuspend.png" alt=""></div>
            <div class="mask_play" @click.stop="go_play(item.albumId,item.sortNo)" v-if="!(item.sortNo==sortNo && item.albumId==albumId && btnStatus==1)"><img src="//9i.dvmama.com/free/2017/08/28/listPlay2.png" alt=""></div>
