    ...
    <div class="course_desc_0" :style="styleObject">
                ...
                <a>
                    <div class="teacher_tit">
                        ...
                        <div class='attention_all' v-if='userId != teacherDescInfo.teacherId'>
                            ...
                            <img class='attention_yes1' src="//9i.dvmama.com/free/2017/05/25/introduce_btn1.png" v-if='attention==0' @click='attention_yes'>
                ...
                <a>
                    <div class="teacher_tit">
                        ...
                        <div class='attention_all' v-if='userId != item.teacherId'>
                            ...
                            <img class='attention_yes1' src="//9i.dvmama.com/free/2017/05/25/introduce_btn1.png" v-if='item.followStatus==0' @click='attention_yes_guest(item.teacherId)'>
        ...
        <div v-if="class_introduce_left==2">
            <div class='discuss_top'>
                 <img v-if='introduceGuide && guide==2 && userTicket==1' class='introduceGuide1' src="//9i.dvmama.com/free/2017/08/11/writeAllSignUp.png" class='writeAllSignUp'>
                 <img v-if='introduceGuide && guide==2 && userTicket==0' class='introduceGuide1' src="//9i.dvmama.com/free/2017/08/11/writeAllNotSignUp.png" class='writeAllSignUp'>
                <div class='discuss_top_write' @click='writeNote' v-if='userTicket==1'>
                    写我的听课笔记
                    <img src="//9i.dvmama.com/free/2017/07/26/write.png">
                ...
                <div class='discuss_top_alldiscuss' @click='allNote'>
                    全部笔记
                    <!-- <img src="//9i.dvmama.com/free/2017/07/26/entry.png"> -->
                </div>
                <i class='icon'></i>
            </div>
            <div class='discuss_container' v-if='notesList.length!=0' :class='{discuss_container_noborder: index == notesList.length-1}' v-for="(item, index) in notesList" @click.stop='show_all(item)'>
                <div class='discuss_title'>
                    ...
                    <img class='title_star title_all' v-if='item.score == 1' src="//9i.dvmama.com/free/2017/05/09/star_1.png">
                    <img class='title_star title_all' v-if='item.score == 2' src="//9i.dvmama.com/free/2017/05/09/star_2.png">
                    <img class='title_star title_all' v-if='item.score == 3' src="//9i.dvmama.com/free/2017/05/09/star_3.png">
                    <img class='title_star title_all' v-if='item.score == 4' src="//9i.dvmama.com/free/2017/05/09/star_4.png">
                    <img class='title_star title_all' v-if='item.score == 5' src="//9i.dvmama.com/free/2017/05/09/star_5.png">
                </div>
                ...
                <div class='discuss_share' v-if='isApp'>
                    <div class='discuss_share_container' @click.stop='share(item)' v-if='isApp'>
                        <img src="//9i.dvmama.com/free/2017/02/07/material-share.png">
            ...
            <div class='no_discuss' v-if='notesList.length==0'>
                <img src="//9i.dvmama.com/free/2017/05/10/error_img.png">
                <p>快来写笔记吧</p>
        ...
        <!--<img v-if='introduceGuide && guide==1' class='introduceGuide lectureNnotesAll' src="//9i.dvmama.com/free/2017/08/08/lectureNnotesAll.png">-->
