        ...
        <div class="head_index_top clearfix" :style="styleArr['head']" id="first">
          <a :href="head.image && head.image.command.content" class="left_icon_container">
            ...
            <!--<img v-if="usersta == 0" class="shop_img"-->
                 <!--src="http://9i.dvmama.com/shop_logo/2016/06/13/80_80_f81f91d7ef5e31fa354fa935124dab20.png">-->
          </a>
        ...
        <div v-if="menudata" class="swiper-container v_menu index_con_menu" id="v_menu" :style="styleArr['v_menu']">
          <ul class="swiper-wrapper" id="swiperLi">
            ...
            <li class="swiper-slide"
                :style="window.$.extend({}, styleArr['li'], item.width && item.width != '0' ? {width:  item.width + 'px'} : {})"
...
<style lang="sass" lang="scss" rel="stylesheet/scss" scoped>
  ...
  .cart_icon{
    ...
    background-size:100%;
    background-image: url(//9i.dvmama.com/free/2017/07/20/shoppingCart.png);
  }
  .cart_icon.classification_icon{
       background-image: url(//9i.dvmama.com/free/2017/07/20/classification.png);
  }
