...
var webpackConfig = {
  ...
  entry: {
    ...
    // noFindGoods: "./src/page/goodsDetail/js/nofind_goods.js", // 弃用
    // home: "./source/javascript/home.config.js", // 弃用
    ...
    // seriesActivity: "./source/javascript/seriesActivity.config.js", // 弃用
    // learn: "./source/javascript/learn.config.js", // 弃用
    ...
    // social: "./source/javascript/social.config.js", // 弃用
    // commonList: "./source/javascript/commonList.config.js", // 弃用
    ...
    seckill_more_discount:
      './source/javascript/seckill_more_discount.config.js',
    orderList_comment_list:
      './source/javascript/orderList_comment_list.config.js',
    ...
    // 绘本节支付结果页刮奖区域
    pay_result_scratch:
      './src/page/pay_result_scratch/js/pay_result_scratch.js',
    ...
    // 订单详情申请售后弹窗
    order_webpack: './javascript/order_webpack.js',

    // 开店页经过编译的js，为了用vue
    detail129_webpack: './javascript/detail129_webpack.js',
    base_title_webpack: './javascript/base_title_webpack.js',
    base_webpack: './javascript/base_webpack.js',

    // 文章详情
    article_new: './source/javascript/article_new.config.js',
  ...
  babel: {presets: ['es2015', 'stage-0', 'stage-1', 'stage-2', 'stage-3']},
  plugins: [
  ...
  resolve: {
    ...
    alias: {vue: __dirname + '/javascript/vue2.0.5.min.js'}
  }
};
